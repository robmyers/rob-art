...
(defmethod maybe-help ()
  ...
  (when (get-arg "help")
    (format t "The Cybernetic Artwork Nobody Wrote~%Rob Myers (C) 2004~%usage: <lisp> run.lisp <options> where option is:~%    -c, --count : the number of images to describe (default: 10)~%~%")
    (quit)))
